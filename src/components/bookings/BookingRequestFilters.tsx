...
export type BookingRequestFilter = "all" | "today"| "completed" | "cancelled" | "confirmed" | "scheduled";
export type ViewMode = "card" | "calendar";

interface BookingRequestFiltersProps {
  activeFilter: BookingRequestFilter;
  onFilterChange: (filter: BookingRequestFilter) => void;
  viewMode: ViewMode;
  onViewModeChange: (mode: ViewMode) => void;
  todayCount?: number;
}

const filters: { key: BookingRequestFilter; label: string }[] = [
  { key: "all", label: "All" },
...
export const BookingRequestFilters = ({
  activeFilter,
  onFilterChange,
  viewMode,
  onViewModeChange,
  todayCount = 0,
}: BookingRequestFiltersProps) => {
  return (

...
export default function Settings() {
  ...
  return (
    <div style={{ background: CREAM, minHeight: "100dvh", fontFamily: "Montserrat,sans-serif", color: TXT }}>
      ...
      {/* ── Top bar ── */}
      <div style={{ background: WHITE, borderBottom: `1px solid ${BORDER}`, paddingLeft: "clamp(16px,4vw,40px)", paddingRight: "clamp(16px,4vw,40px)", paddingTop: "var(--sat, 0px)", paddingBottom: 0, position: "sticky", top: 0, zIndex: 10, boxShadow: "0 1px 0 rgba(0,0,0,0.04)" }}>

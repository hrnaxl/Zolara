...
export default function Settings() {
  ...
  return (
    <div style={{ background: CREAM, minHeight: "100vh", fontFamily: "Montserrat,sans-serif", color: TXT }}>
      ...
      {/* ── Top bar ── */}
      <div className="pwa-topbar" style={{ background: WHITE, borderBottom: `1px solid ${BORDER}`, padding: "0 clamp(16px,4vw,40px)", position: "sticky", top: 0, zIndex: 10, boxShadow: "0 1px 0 rgba(0,0,0,0.04)" }}>

...
const TIERS = [
  ...
  { min: 200,  max: 499,  name: "Silver",   color: "#A8A8A8", bg: "rgba(168,168,168,0.1)",  next: 500,  perks: ["All Bronze perks", "Priority booking", "Complimentary hand massage"] },
  ...
  { min: 1000, max: Infinity, name: "Platinum", color: "#6366F1", bg: "rgba(99,102,241,0.1)", next: null, perks: ["All Gold perks", "VIP priority always", "Free monthly treatment", "Personal beauty consultant"] },
];

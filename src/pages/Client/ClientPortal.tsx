...
const TIERS = [
  ...
  { min: 200,  name: "Silver",   color: "#A0A0A0", bg: "rgba(160,160,160,0.15)" },
  { min: 500,  name: "Gold",     color: G,          bg: "rgba(200,169,126,0.15)" },
  { min: 1000, name: "Platinum", color: "#B9F2FF",  bg: "rgba(185,242,255,0.15)" },
];

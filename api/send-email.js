...
export default async function handler(req, res) {
  ...
  try {
    ...
    const r = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({ from: "Zolara Beauty Studio <noreply@noreply.zolarasalon.com>", reply_to: "zolarabeautystudio@gmail.com", to: Array.isArray(to) ? to : [to], subject, html }),
    });
